...
if __name__ == '__main__':
    ...
    points = []
    for row in matrix_of_file_names:
        group_stage_prediction = gsfp(row[0])
        round_of_16_prediction = ro16fp(row[1], group_stage_prediction)
        quarter_finals_prediction = qffp(row[2], round_of_16_prediction)
        # print(quarter_finals_prediction)
        # semi_finals_prediction = sffp(row[3], quarter_finals_prediction)
        # print(semi_finals_prediction)
        # final_prediction = ffp(row[4], semi_finals_prediction)
        # print(final_prediction)
        # print(cal(group_stage_prediction, round_of_16_prediction, quarter_finals_prediction, semi_finals_prediction,
        #       final_prediction))
